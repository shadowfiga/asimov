...
Open `Graphite.gumx` by double-clicking `gum.cmd` at the project root. The project includes Gum's official Standard Forms components plus editable `MainMenuScreen` and `CounterScreen` layouts.
